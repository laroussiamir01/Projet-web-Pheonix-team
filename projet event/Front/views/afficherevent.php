...
<div class="main_body">
  ...
  <!------------------------------------>
  <h2 class="mx-auto text-center m-5"> Les evenements</h2>
  <div class = "container text-center"> 
  <h4  style="text-align:center" ><a href="ajouterevent.php" > Ajouter evenement</a></h4>
    <br><br>
    <table class="table" >
    <thead>
        <tr>
          <th>ID</th>
          <th>Name Evenement</th>
          <th>Date Debut</th>
          <th>Date Fin</th>
                            ...
                            <td><?php echo $event['nom_event']; ?></td>
                             <td><?php echo $event['date_debut_event']; ?></td>
                              <td><?php echo $event['date_fin_event']; ?></td>
                                ...
                                <td><a href="supprimerevent.php?id_event=<?php echo $event['id_event']; ?>" class="btn btn-danger">Supprimer</a></td>
                            </tr>
                       <?php } ?>
                        </tbody>
                        </table>
