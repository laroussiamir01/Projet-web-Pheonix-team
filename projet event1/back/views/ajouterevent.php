            ...
            <form action="" method="POST">
                ...
                <table border="1" align="center">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="id_event" id="id_event" maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label for="date_debut_event">date_debut_event:
                            </label>
                           
                        </td>
                        <td><input type="date" name="date_debut_event" id="date_debut_event" maxlength="20"></td>
                    </tr>
                    <td>
                             <label for="date_fin_event">Date fin eventn:
                            </label>
                        </td>
                        <td><input type="date" name="date_fin_event" id="date_fin_event" maxlength="20"></td>
                    </tr>
